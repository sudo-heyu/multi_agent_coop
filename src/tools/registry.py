    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "② 优先级排序：traffic_priority 来自当前状态而非固定 AP 身份；"
                "当优先级确实不同，校验 AP 之间 CWmin 和 AIFSN 是否满足单调性：\n"
                "  high 通常使用更小的 CWmin 和 AIFSN，以缩短退避和 AIFS 等待时间；\n"
                "  low 通常使用更大的 CWmin 和 AIFSN，以降低自身竞争强度；\n"
                "  要求 high.CWmin ≤ medium.CWmin ≤ low.CWmin，AIFSN 同理。\n"
                "若所有 AP 优先级相同或缺省为 medium，不要为了展示 Co-EDCA 强行制造梯度。\n"
